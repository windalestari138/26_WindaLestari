<!DOCTYPE HTML>
<head>
<title>OlshopCosmetik_Renii | About</title>
<meta charset="utf-8">
<!-- CSS Files -->
...
<link rel="stylesheet" type="text/css" href="boxes/<?php echo base_url();?>assets/css/style6.css">
<!-- JS Files -->
...
<div id="container">
  <div class="two-third">
    <div id="slider3" class="nivoSlider" style="width: 630px; height: 280px"> <a href="#"><img title="OlshopCosmetik_Renii" src="<?php echo base_url();?>assets/img/demo/about1.jpg" alt="" width="630" height="280"></a> <img src="<?php echo base_url();?>assets/img/demo/about2.png" alt="" width="630" height="280"> <img src="<?php echo base_url();?>assets/img/demo/about3.png" alt="" width="630" height="280"> </div>
    <div style="clear:both"></div>
    <center><div class="one-third">
      <h2>Profil Admin</h2>
      <img src="<?php echo base_url();?>assets/img/reni.png" alt="">
      <center><p>Nama saya Reni Siahaan, saya adalah pemilik usaha olshop cosmetik online ini. Reni sudah 1 tahun menjalanakan usaha olshop cosmetik online. "Happy Shopping Sis"</p></center>
    </div></center>
  </div>
  <!-- end sidebar right -->
