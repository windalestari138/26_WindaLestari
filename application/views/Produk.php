...
<body>
    <div class="header">
        ...
        <?php foreach ($produk as $key => $value) { ?>
            <div class="one-fifth">
            <a href="#"><img src="<?php echo site_url();?>assets/admin/uploads/<?php echo $value->gambar; ?>" alt="" width="158" height="100" class="portfolio-img pretty-box"></a>
            ...
            <li class="list-group-item">
              ...
              <center>
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">
                       <a href="<?php echo base_url()."LoginCustomer"?>" class="btn btn-primary">Pesan</a>
                    </li>
                </ul>
                </center>
            </li>
